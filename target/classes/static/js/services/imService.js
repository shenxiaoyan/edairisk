...
angular.module('app').service('imService',
    [
        "$rootScope",
        function ($rootScope) {
...
//帐号模式，0-表示独立模式，1-表示托管模式
            ...
            var sdkAppID = 1400049995;
            var accountType = 19144;
            //当前用户身份
            var loginInfo = {
            ...
            this.setLoginInfo = function (info) {
                loginInfo.identifier = info.openid;
...
//聊天页面增加一条消息
            function addMsg(msg, prepend) {
                ...
                if (msg.fromAccount === "admin") {
                    ...
                    //$rootScope.unReadNumber = sessMap["C2Cadmin"].unread();
                } else {
                ...
                for (var j in newMsgList) {//遍历新消息
                    ...
                    if (newMsg.getSession().id() == selToID) {//为当前聊天对象的消息
                        ...
                        $rootScope.$apply(function () {
                            //$rootScope.unReadNumber = sessMap["C2Cadmin"].unread();
                            $rootScope.toasterSuccess("通知！","您有一条新的通知！");
                        });
                    }
                }
                //消息已读上报，以及设置会话自动已读标记
