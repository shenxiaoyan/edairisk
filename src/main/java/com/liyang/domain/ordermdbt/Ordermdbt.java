...
public class Ordermdbt extends AbstractWorkflowEntity<OrdermdbtWorkflow, OrdermdbtState, OrdermdbtAct, OrdermdbtLog,OrdermdbtFile> {
	...
	@ManyToOne
	@JoinColumn(name="apply_company_id")
	@Info(label="申请公司",placeholder="",tip="",help="",secret="")
	private Company company;
	
	@Column(name = "apply_purchase_price",precision=19,scale=3)
	@Info(label="面单采购价",placeholder="",tip="",help="",secret="")
	private BigDecimal applyPurchasePrice;//面单采购价
	...
	public BigDecimal getApplyPurchasePrice() {
		return applyPurchasePrice;
	}

	public void setApplyPurchasePrice(BigDecimal applyPurchasePrice) {
	...
	public static void setService(AbstractWorkflowService service) {
		Ordermdbt.service = service;
	}
	...
	public String toString() {
		return "Ordermdbt [application=" + application + ", product=" + product + ", user=" + user + ", orderNo="
				+ orderNo + ", person=" + person + ", applyAmount=" + applyAmount + ", comfirmAmount=" + comfirmAmount
				+ ", applyPeriodNumber=" + applyPeriodNumber + ", realName=" + realName + ", applyMobile=" + applyMobile
				+ ", applyIdentityNo=" + applyIdentityNo + ", enterprise=" + enterprise + ", applyEnterpriseName="
				+ applyEnterpriseName + ", applyEnterpriseReigionName=" + applyEnterpriseReigionName
				+ ", applyEnterpriseAddress=" + applyEnterpriseAddress + ", applyReferrerRealName="
				+ applyReferrerRealName + ", applyDayPickExpress=" + applyDayPickExpress + ", applyDayPatchExpress="
				+ applyDayPatchExpress + ", applyWayBillFee=" + applyWayBillFee + ", comment=" + comment
				+ ", applyEnterpriseProvince=" + applyEnterpriseProvince + ", applyEnterpriseCity="
				+ applyEnterpriseCity + ", applyEnterpriseDistrict=" + applyEnterpriseDistrict
				+ ", applyEnterpriseTown=" + applyEnterpriseTown + ", applyPeriodCode=" + applyPeriodCode
				+ ", debtorAccount=" + debtorAccount + ", debtorReceiveAccount=" + debtorReceiveAccount
				+ ", serviceUser=" + serviceUser + ", isDistribution=" + isDistribution + ", serviceName=" + serviceName
				+ ", company=" + company + ", applyPurchasePrice=" + applyPurchasePrice + ", agentBrand=" + agentBrand
				+ ", debtorCreditcard=" + debtorCreditcard + ", serviceId=" + serviceId + "]";
	}
