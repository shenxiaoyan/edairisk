...
function addMsg(msg, prepend) {
    ...
    if (typeof msg.elems[0].content.ext === "object") {
        var href = "#/" + msg.elems[0].content.ext.entityType + "/workflows/" + msg.elems[0].content.ext.workflowId + "/" + msg.elems[0].content.ext.entityName + "/" + msg.elems[0].content.ext.entityId + "/profile/info";
    }
    ...
    } else if (webim.Tool.formatText2Html(fromAccountNick) === "2") {
    ...
    } else if (webim.Tool.formatText2Html(fromAccountNick) === "4") {
