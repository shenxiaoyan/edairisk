...
@Cacheable
@Info(label="哒哒车服",secret="哒哒车服")
public class Ordercddloan extends AbstractWorkflowEntity<OrdercddloanWorkflow, OrdercddloanState, OrdercddloanAct, OrdercddloanLog,OrdercddloanFile> {
